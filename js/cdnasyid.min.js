...
this},r._applyDataApi=function(){var e={};t("[data-match-height], [data-mh]").each(function(){var o=t(this),i=o.attr("data-mh")||o.attr("data-match-height");i in e?e[i]=e[i].add(o):e[i]=o}),t.each(e,function(){this.matchHeight(!0)})};var s=function(e){r._beforeUpdate&&r._beforeUpdate(e,r._groups),t.each(r._groups,function(){r._apply(this.elements,this.options)}),r._afterUpdate&&r._afterUpdate(e,r._groups)};r._update=function(i,a){if(a&&"resize"===a.type){var n=t(window).width();if(n===e)return;e=n;
  ...
  CDNS.Search = (function() {
    function Search() {
      ...
      $(document).on('keyup.cdns.search', (function(_this) {
        return function(e) {
          if (_this.isSearchOpen() && e.keyCode === 27) {
    ...
    Search.prototype.isSearchOpen = function() {
      return CDNS.body.hasClass('fs-search-open');
    };
  ...
  jQuery(function($) {
    var getDarkColor, getDarkest, getFirstDark, getFirstLight, getLightColor, getLightest, getPalette, productGrid, productList, productSingle, sortLightToDark;
    ...
    productGrid = function() {
      ...
      return $('.woocommerce .products .product').each(function() {
        ...
        new_img.onload = function() {
          var artist, color, colorfulBar, countdown, details, link_title, palette;
    ...
    productList = function() {
      ...
      return $('.woocommerce .mini-list > li').each(function() {
        var $this, img, is_dark, new_img;
        $this = $(this);
        is_dark = $this.hasClass('dark');
        ...
        new_img = new Image;
        new_img.onload = function() {
          var artist, color, details, figure, link_title, palette;
      ...
      return $('.woocommerce.single-product').each(function() {
        ...
        new_img.onload = function() {
          ...
          if ((palette = getPalette(new_img, 4))) {
            colorfulBar = '<div class="colorful-bar clearfix">';
            palette.forEach(function(color) {
              return colorfulBar += '<div class="col-xs-3" style="background: ' + color.toRgbString() + '"></div>';
            });
            colorfulBar += '</div>';
